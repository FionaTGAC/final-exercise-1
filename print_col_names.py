...
def replace_whitespace(word, chr):
  return word.replace(" ", chr)
  
stri=""
for col in col_names:
  stri += replace_whitespace(col, "")+ "\n"

print stri
fout = open("columnNames.txt", "w")
fout.write(stri)
fout.close()
...
print stri
fout = open("sorted_columnNames.txt", "w")
fout.write(stri)
fout.close()
...
#replace_whitespace(" test ", "*")



# STEP 1 - Define a function below called "replace_whitespace" that can replace characters in a string with others. 
# The function should take two parameters, the first being the string that needs whitespace characters replacing, 
# and the second being the character to insert instead of the whitespace.



# STEP 2 - output the new column names generated by running your replace_whitespace function
# BONUS - trim any leading (at the front of the string) or trailing (at the end) whitespace characters from each column 
# name before you call your replace_whitespace function
...
# Push the following files to Aleksandra's github: this file containing the fixed code, file with the column names with spaces removed,
#and the file with the sorted names
